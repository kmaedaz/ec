...
class OrderRepository extends EntityRepository
{
     ...
     * @return QueryBuilder
     */
    public function getQueryBuilderBySearchDataForAdminGroup($searchData)
    {
        $qb = $this->createQueryBuilder('o')
                    ->Where('o.CustomerGroup.group_id IN NOT NULL')
                    ->leftJoin('o.CustomerGroup', 'cg');
     ...
     * @return QueryBuilder
     */
    public function getQueryBuilderByGroup($GroupOrderId)
    {
        $qb = $this->createQueryBuilder('o')
            ->leftJoin('o.GroupOrder', 'go')
